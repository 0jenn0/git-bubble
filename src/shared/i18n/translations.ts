export const translations = {
  ko: {
    ...
    villageUsernameDescription: '올해 커밋 수에 따라 캐릭터가 생성됩니다',
    villageDescription: '커밋할수록 마을에 주민이 늘어나요! 캐릭터들이 마을을 돌아다니며 대화해요.',
    villageInfo: '마을 정보',
    villageInfoYear: '올해 커밋 수를 기준으로 계산됩니다',
    villageInfoCommits: '100커밋마다 새로운 캐릭터가 추가됩니다 (최대 12마리)',
  ...
  en: {
    ...
    villageInfoYear: 'Based on this year\'s commit count',
    villageInfoCommits: 'A new character is added for every 100 commits (max 12)',
